...
const slides = [
  {
    ...
    bgImage: "/images/hero/hero__cvgr5aj1ttsi_large_2x.jpg",
  ...
  },
  {
    ...
    bgImage: "/images/galaxy-s26-ultra-features-kv.jpg",
  ...
  },
  {
    ...
    bgImage: "/images/hero/sensors_chips__s805s5o3gkii_large.jpg",
    textColor: "text-white",
    theme: "dark",
    align: "center",
    bgPosition: "center",
        ...
        >
          ...
          {/* <div
						className={`absolute inset-0 bg-gradient-to-b ${
							slide.theme === "dark"
								? "from-black/80 via-black/20 to-black/60"
