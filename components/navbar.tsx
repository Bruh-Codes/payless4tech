                            ...
                            <div className="border-l border-border/30 pl-3 space-y-1">
                              {category.children.map((child) => (
                                <button
                                  ...
                                  className="block w-full text-left text-sm text-muted-foreground/70 hover:text-gray-600 hover:bg-accent/10 transition-colors cursor-pointer p-2 rounded-md category-dropdown-item"
                                >
                                  {child.name}
                                </button>
                              ))}
                            ...
                            {category.children && (
                              <div className=" pl-2 border-l border-border/30">
                                {category.children.map((child) => (
                                  ...
                                  >
                                    <p className="text-xs text-muted-foreground/70 hover:text-gray-600 transition-colors">
                                      {child.name}
                                    </p>
                                  </button>
                                ))}
